...
protected:
	...
	afx_msg void OnOrdersSubscribe();
	afx_msg void OnOrdersUnsubscribe();
	afx_msg void OnOrdersStart();
	afx_msg void OnTradesSubscribe();
	afx_msg void OnTradesUnsubscribe();
	afx_msg void OnTradesStart();
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
};
