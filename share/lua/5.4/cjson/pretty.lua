--[[
    https://raw.githubusercontent.com/bungle/lua-resty-prettycjson/refs/heads/master/lib/resty/prettycjson.lua

    https://github.com/bungle/lua-resty-prettycjson
    https://luarocks.org/modules/bungle/lua-resty-prettycjson

    lua-resty-prettycjson is a JSON Pretty Formatter for Lua cJSON.

    local pretty = require "cjson.pretty"
    print(pretty({
        key1 = "data",
        key2 = 27,
        key3 = {
